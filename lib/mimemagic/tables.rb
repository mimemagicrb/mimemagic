...
# Generated from script/freedesktop.org.xml.in
class MimeMagic
  # @private
  # :nodoc:
  EXTENSIONS = {
  ...
  TYPES = {
    ...
    'application/x-dc-rom' => [%w(dc), %w(), 'Dreamcast disc image'],
    ...
    'application/x-kexiproject-sqlite3' => [%w(kexi), %w(application/x-sqlite3), 'Kexi database file'],
    ...
    'image/avif' => [%w(avif), %w(), 'AV1 Image File Format (AVIF)'],
    'image/avif-sequence' => [%w(avifs), %w(), 'AVIF image sequence'],
    'image/bmp' => [%w(bmp dib), %w(), 'Windows BMP image'],
    'image/cgm' => [%w(cgm), %w(), 'CGM image'],
    'image/emf' => [%w(emf), %w(), 'EMF image'],
    'image/fax-g3' => [%w(g3), %w(), 'CCITT G3 fax image'],
  ...
  MAGIC = [
    ...
    ['font/woff', [[0, 'wOFF']]],
    ['font/woff2', [[0, 'wOF2']]],
    ['image/avif', [[4, 'ftypavif'], [4, 'ftypmif1']]],
    ['image/avif-sequence', [[4, 'ftypavis']]],
    ['image/dpx', [[0, 'SDPX']]],
