...
class MimeMagic
  ...
  TYPES = {
    ...
    'application/xml' => [%w(xml rng xbl xsd), %w(text/plain), 'XML document'],
    ...
    'text/x-c++src' => [%w(cpp c c++ cc cxx), %w(text/x-csrc), 'C++ source code'],
    ...
    'video/3gpp' => [%w(3gpp 3ga 3gp), %w(video/mp4), '3GPP multimedia file'],
    'video/3gpp2' => [%w(3gpp2 3g2 3gp2), %w(video/mp4), '3GPP2 multimedia file'],
    ...
    'video/mp2t' => [%w(ts bdm bdmv clpi cpi m2t m2ts mpl mpls mts), %w(), 'MPEG-2 transport stream'],
    'video/mp4' => [%w(mp4 f4v lrv m4v), %w(), 'MPEG-4 video'],
    'video/mpeg' => [%w(mp2 mpe mpeg mpg vob), %w(), 'MPEG video'],
    'video/ogg' => [%w(ogg ogv), %w(application/ogg), 'Ogg Video'],
    'video/quicktime' => [%w(mov moov qt qtvr), %w(), 'QuickTime video'],
